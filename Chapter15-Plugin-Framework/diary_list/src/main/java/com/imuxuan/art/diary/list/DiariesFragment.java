...
//        ARouter.getInstance().build("/diary/edit").navigation();
        Small.openUri("diary_edit", getActivity());
    }

    @Override
    public void gotoUpdateDiary(String diaryId) { // 跳转更新日记
//        ARouter.getInstance().build("/diary/edit")
//                .withString("diary_id", diaryId)
//                .navigation();
        Small.openUri("diary_edit?diaryId=" + diaryId, getActivity());
    }
