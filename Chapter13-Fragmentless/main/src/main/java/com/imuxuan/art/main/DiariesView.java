...
public class DiariesView extends LinearLayout implements DiariesContract.View { // 日记展示页面
    ...
    private void init() {
        // 加载日记页面布局
        inflate(getContext(), R.layout.fragment_diaries, this);
...
//    }
    ...
    public boolean isActive() {
        return mActive; // 判断Fragment是否已经添加到了Activity中
    }
}
