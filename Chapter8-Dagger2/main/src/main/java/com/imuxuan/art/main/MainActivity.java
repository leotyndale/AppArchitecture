...
import com.imuxuan.art.main.di.DaggerDiariesComponent;
import com.imuxuan.art.main.di.DiariesPresenterModule;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Inject
    DiariesPresenter mDiariesPresenter;
    ...
    private void initFragment() {
        ...
        DaggerDiariesComponent.builder()
                .diariesRepositoryComponent(EnApplication.get().getDiariesRepositoryComponent())
                .diariesPresenterModule(new DiariesPresenterModule(diariesFragment))
                .build().inject(this);
        diariesFragment.setPresenter(mDiariesPresenter); // 设置主持人
    }
